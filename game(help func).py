...
def print_help():
        print('you can choose easy ,meduim,or hard')
        print('You can go north south east or west')
        print('you can pick pen, computer, crossword book, ball, teapot, beet, or dundie')
        print('you can drop pen, computer, crossword book, ball, teapot, beet, or dundie')
        print('you can take pen, computer, crossword book, ball, teapot, beet, or dundie')
        print('you can give pen, computer, crossword book, ball, teapot, beet, or dundie')
        print('you can talk to Pam, Jim, Dwight, Stanley, or Michael')
        print('you can check where Pam, Jim, Dwight, Stanley, or Michael')
